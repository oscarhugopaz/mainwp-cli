...
### Changed
- Homebrew tap migrated from `oscarhugopaz/homebrew-mainwp-cli` to the
  canonical tap name `oscarhugopaz/tap` (repository:
  [oscarhugopaz/homebrew-tap](https://github.com/oscarhugopaz/homebrew-tap)).
  Install with `brew install oscarhugopaz/tap/mainwp-cli`. Users of the
  old tap should `brew untap oscarhugopaz/mainwp-cli` first.
